...
export default (variables = variable) => {
  ...
  const headerTheme = {
    ...
    '.transparent': {
      ...
      height: platform === 'android' ? variables.toolbarHeight + (StatusBar.currentHeight ? StatusBar.currentHeight : 0) : variables.toolbarHeight
    },
    '.noShadow': {
      elevation: 0,
      shadowColor: null,
    ...
    height:
      variables.platform === 'ios' && variables.platformStyle === 'material'
        ? variables.toolbarHeight + (StatusBar.currentHeight ? StatusBar.currentHeight : 0)
